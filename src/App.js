    ...
    <div className="App">
      <header className="hero" style={{ backgroundImage: "url('/banner2.jpg')" }}>
        <div className="overlay">
          <h1>Jeremy Chan</h1>
          <p className = "headhead">Final year EEE undergrad with an endless hunger to learn</p>
      ...
      <section className="about">
        ...
        <p>I'm interested in robotics, neuromorphic computing, circuit design, and software development. My recent experiences include working as an instrumentation and data analytics intern at Procter & Gamble Gillette, teaching and a summer studentship at UCL, serving as Vice President of UCL's EEE Society, and being the Outreach Manager for the Robotics Society.</p>
